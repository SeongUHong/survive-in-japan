...
function addMetaDataInput() {
  $("#add-meta-data-input-btn").on("click", function () {
    var html = "<div class='input-group mb-3 meta-data'>" + "<input type='text' class='form-control meta-data-name' placeholder='Name'>" + "<input type='text' class='form-control meta-data-content' placeholder='Value'>";
    "</div>";
    $(this).before(html);
  });
}

...
function applyTxtDesign(targetElement) {
  ...
  // 디자인 적용
  if (designName == "left-line" || designName == "kakomisen" || designName == "haikeiiro" || designName == "short-underline" || designName == "subcopy") {
...
function addMetaDataInput() {
  $("#add-meta-data-input-btn").on("click", function () {
    var html = "<div class='input-group mb-3 meta-data'>" + "<input type='text' class='form-control meta-data-key' placeholder='Name'>" + "<input type='text' class='form-control meta-data-value' placeholder='Value'>" + "</div>";
    $(this).before(html);
  });
}
